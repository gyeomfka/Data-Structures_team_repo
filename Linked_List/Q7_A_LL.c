...
/**
 *
 * 재귀(Recursion) 를 사용하여 주어진 단일 연결 리스트(singly linked list) 를 역순으로 뒤집는 C 함수를 작성하시오.
	단, 각 노드의 next 포인터와 리스트의 head 포인터를 변경하여 뒤집어야 한다.
 *
 */
...
void RecursiveReverse(ListNode **ptrHead)
{
	...
	// if (ptrHead == NULL || next == NULL) {
	if (cur == NULL || next == NULL) {
		//TODO: 최종적으로 head를 변경한다.
